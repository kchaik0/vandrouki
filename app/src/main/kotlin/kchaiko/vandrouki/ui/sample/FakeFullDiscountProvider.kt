package kchaiko.vandrouki.ui.sample
...
class FakeFullDiscountProvider : PreviewParameterProvider<Pair<Discount, String>> {
    override val values: Sequence<Pair<Discount, String>>
        get() = sequenceOf(
            Discount(
                author = "dreamisreal",
                date = Date(),
                ...
                desc = "",
                detailUrlPart = ""
            ) to "<p>Уже завтра. Старт полетов в Минеральные Воды из Минска российской авиакомпанией Азимут. Билеты на первые рейсы всего от 118 рублей в одну или от 230 рублей туда-обратно!<span id=\"more-83106\"></span></p> \n" +
